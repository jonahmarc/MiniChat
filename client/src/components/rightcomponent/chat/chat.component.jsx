    ...
    return (
        <Stack className="right_container m-0">
            ...
            <div className="input d-grid gap-2 d-flex align-items-center justify-content-start">
                <UploadFile />
                <Button variant="light" type='' onClick={togglePicker} ><i class="bi bi-emoji-smile"></i></Button>
                    {pickerOpen && (
                ...
                <Form className='d-grid gap-2 d-flex align-items-center justify-content-between flex-fill'>
                    <Form.Control className="me-auto" type="text" onChange={handleInput} value={input} placeholder="Enter  Message"  />
